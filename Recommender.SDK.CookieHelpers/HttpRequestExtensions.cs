...
namespace Kentico.Kontent.Recommender.SDK.CookieHelper
{
    public static class HttpRequestExtensions
    {
        ...
        /// <returns></returns>
        public static TrackingCookieModel GetRecommenderTrackingCookie(this HttpRequest request)
        {
        ...
        /// <returns></returns>
        public static TrackingCookieModel SetNewRecommenderTrackingCookie(this HttpRequest request, HttpResponse response, TimeSpan? expiration = null, string hostname = null)
        {
            if (expiration == null) expiration = TimeSpan.FromDays(365);
            if (string.IsNullOrEmpty(hostname)) hostname = request.Headers["Host"];
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public static VisitDetail GetVisitDetail(this HttpRequest request)
        {
